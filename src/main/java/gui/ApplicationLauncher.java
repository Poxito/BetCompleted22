...
//			UIManager.setLookAndFeel("com.sun.java.swing.plaf.motif.MotifLookAndFeel");
			...
			if (c.isBusinessLogicLocal()) {
				...
				appFacadeInterface=Factory.sortuFactory(0);
				System.out.println("Konexio lokala");	
			}	
			else { //If remote
				...
				appFacadeInterface=Factory.sortuFactory(1);
				System.out.println("Urruneko konexioa");
			} 
